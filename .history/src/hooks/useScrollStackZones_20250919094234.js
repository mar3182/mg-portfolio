  ...
  useEffect(() => {
    ...
    const handleActivate = () => {
      ...
      if (!document.body.classList.contains(bodyClass)) {
        ...
        document.body.dataset.stackSource = 'scroll'
      }
    }
    ...
    const handleDeactivate = () => {
      ...
      removeTimer = setTimeout(() => {
        ...
        if (activeCount === 0) {
          ...
          document.body.classList.remove('showcase-card-unhover')
          if (document.body.dataset.stackSource === 'scroll') {
            delete document.body.dataset.stackSource
          }
        }
      }, removeDelay)
    }
    ...
    const onScroll = () => {
      ...
      lastScrollY = y
      // Promote readiness as soon as the user scrolls at all
      if (!document.body.classList.contains('stacking-ready') && y > 0) {
