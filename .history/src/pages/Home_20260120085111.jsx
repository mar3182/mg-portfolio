...
// Cinematic Portrait Hero - editorial-style mouse-reactive dual identity
const CinematicPortraitHero = lazy(() => import('../components/CinematicPortraitHero'))
...
export default function Home() {
  ...
  // Navigation state for design/tech project sections (Step 3 - explicit action)
  const [activeSection, setActiveSection] = useState('center')
  
  // Identity zone tracking (Step 2 - just for visual feedback, not navigation)
  const [identityZone, setIdentityZone] = useState('neutral')
  ...
  return (
    <>
      {/* ═══ Cinematic Portrait Hero — Mouse-based identity navigation ═══ */}
      <Suspense fallback={<HeroFallback />}>
        <CinematicPortraitHero 
          ...
          onIdentityChange={(zone) => setActiveSection(zone)}
        />
      </Suspense>
