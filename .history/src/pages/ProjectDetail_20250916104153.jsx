      ...
      <div className="project-detail-inner" style={{ maxWidth:1200, margin:'0 auto', padding:'0 2rem' }}>
        ...
        {(prevProject || nextProject) && (
          <div className="next-project" style={{ 
            ...
            {nextProject && (
              <div className="preview-anchor" style={{ display:'flex', alignItems:'center', gap:'.6rem', minWidth:0, position:'relative' }}>
                ...
                {(nextProject.avif || nextProject.webp || nextProject.jpg) && (
                  <div className="next-preview" aria-hidden="true">
                    <picture>
                      {nextProject.avif && (
                        <source type="image/avif" srcSet={nextProject.avif} sizes="160px" />
                      )}
                      {nextProject.webp && (
                        <source type="image/webp" srcSet={nextProject.webp} sizes="160px" />
                      )}
                      <img
                        src={nextProject.image || nextProject.thumb}
                        srcSet={nextProject.jpg || undefined}
                        sizes="160px"
                        alt=""
                        loading="lazy"
                        width={160}
                        height={120}
                        style={{ display:'block', width:'100%', height:'auto', borderRadius:'0.6rem' }}
                      />
                    </picture>
                    <div className="preview-caption">
                      {nextProject.category}
                      {nextProject.year ? <span> · {nextProject.year}</span> : null}
                    </div>
                  </div>
                )}
              </div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:'.6rem' }}>
              {prevProject && (
                <div className="preview-anchor" style={{ position:'relative' }}>
                  <Link 
                  ...
                  {(prevProject.avif || prevProject.webp || prevProject.jpg) && (
                    <div className="prev-preview" aria-hidden="true">
                      <picture>
                        {prevProject.avif && (
                          <source type="image/avif" srcSet={prevProject.avif} sizes="160px" />
                        )}
                        {prevProject.webp && (
                          <source type="image/webp" srcSet={prevProject.webp} sizes="160px" />
                        )}
                        <img
                          src={prevProject.image || prevProject.thumb}
                          srcSet={prevProject.jpg || undefined}
                          sizes="160px"
                          alt=""
                          loading="lazy"
                          width={160}
                      ...
                      <div className="preview-caption">
                        ...
                        {prevProject.year ? <span> · {prevProject.year}</span> : null}
                      </div>
                    </div>
                  )}
                </div>
