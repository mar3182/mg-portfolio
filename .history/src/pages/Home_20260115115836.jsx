...
export default function Home() {
  ...
  return (
    <>
      {/* ═══ Morphing Hero — T-Shaped Creative Identity ═══ */}
      <Suspense fallback={<HeroFallback />}>
        <MorphingHero onIdentityChange={(identity) => {
          // Could be used to update other page elements based on current identity
          console.log('Identity switched to:', identity.id)
        }} />
      </Suspense>
