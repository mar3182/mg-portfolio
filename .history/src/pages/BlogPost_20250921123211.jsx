  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
      ...
      <main className="px-6" style={{ paddingBottom: '4rem' }}>
        <div className="blog-inner">
          <RevealWrapper>
            <article className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl border border-slate-200/50 dark:border-slate-700/50 prose prose-slate dark:prose-invert max-w-3xl mx-auto" style={{ padding: '3rem 2.5rem' }}>
