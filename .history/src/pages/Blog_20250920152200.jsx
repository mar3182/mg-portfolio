          ...
          <div className="max-w-4xl mx-auto">
            <RevealWrapper>
              ...
              <Link to={`/blog/${featuredPost.slug}`} className="block group focus-ring-link">
                <article className="bg-slate-50 rounded-lg p-8 border border-slate-200 transition-all duration-300 hover:shadow-lg hover:border-slate-300">
                ...
                {(searchActive || !featuredPost ? filteredPosts : regularPosts).map((post) => (
                  <StaggerItem key={post.id}>
                    <Link to={`/blog/${post.slug}`} className="block h-full group focus-ring-link">
                      <article className="h-full bg-white rounded-lg p-6 border border-slate-200 transition-all duration-300 hover:shadow-lg hover:border-slate-300 flex flex-col">
                        <div className="flex flex-wrap gap-2 mb-4">
