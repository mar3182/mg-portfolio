      ...
      <div className="px-6" style={{ paddingTop: '6rem', paddingBottom: '3rem' }}>
        <div className="blog-inner">
          <RevealWrapper>
            <Link 
              to="/blog" 
              className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors group focus-ring-link"
