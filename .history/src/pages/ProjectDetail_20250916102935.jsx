      ...
      <div className="project-detail-inner" style={{ maxWidth:1200, margin:'0 auto', padding:'0 2rem' }}>
        ...
        {nextProject && (
          <div className="next-project" style={{ 
            ...
            <div>
              <div style={{ fontSize:'.75rem', letterSpacing:'.12em', textTransform:'uppercase', opacity:.6, marginBottom:'.25rem' }}>Next project</div>
              <div style={{ fontWeight:600 }}>{nextProject.title}</div>
            </div>
            <Link 
