...
const options = [
  { num:'01', hash:'contact-project', title:'A project', desc:'Tell me about your product or idea.', details:'Provide a short brief: goals, timeline, budget range.' },
  { num:'02', hash:'contact-application', title:'Application', desc:'Interested in collaborating? Reach out.', details:'Share your portfolio / GitHub and what you like to build.' }
]
...
export default function Contact() {
  ...
  React.useEffect(()=>{
    ...
    const match = options.find(o=>o.hash===h)
    if(match) setOpen(match.num)
  },[])
  ...
  <div className="contact-scroll-cue" aria-hidden="true">↓</div>
          ...
          {options.map(o => {
            ...
            return (
              <div key={o.num} className={"contact-option" + (isOpen? ' is-open':'')} role="listitem">
                <button className="contact-toggle" aria-expanded={isOpen} onClick={()=>toggle(o.num)} id={o.hash}>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      ...
                      <form className="contact-form" onSubmit={submit} noValidate aria-describedby={status? 'form-status': undefined}>
                        ...
                        <div id="form-status" aria-live="polite" style={{position:'absolute', left:'-9999px'}}>{status}</div>
                      </form>
                    </Motion.div>
                  )}
                </AnimatePresence>
        ...
        <div className="contact-details">
          <p><strong>Email:</strong> <a href="mailto:mar3182@zeelandnet.nl">mar3182@zeelandnet.nl</a></p>
          <p><strong>Phone:</strong> <a href="tel:+31611108028">+31 611 108 028</a></p>
        </div>
  <div className="contact-team-photo" aria-label="Team photograph placeholder" role="img"></div>
      </div>
    </section>
  )
}
