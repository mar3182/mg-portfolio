...
// Dual Identity Hero - One portrait, two worlds (Design/Tech) via mouse position
const DualIdentityHero = lazy(() => import('../components/DualIdentityHero'))
...
export default function Home() {
  ...
  return (
    <>
      {/* ═══ Dual Identity Hero — One portrait, two worlds ═══ */}
      <Suspense fallback={<HeroFallback />}>
        <DualIdentityHero 
          portraitSrc="/portrait-design-nb.png"
