...
export default function ProjectDetail() {
  ...
  return (
    <section style={{ padding: '6rem 2rem', minHeight: '80vh' }}>
      ...
      >
        <h1 style={{ fontSize: '4rem', lineHeight: 0.9, marginBottom: '2rem' }}>{project.title}</h1>
        <div style={{ background: project.color, borderRadius: 12, padding: '3rem 2rem', marginBottom: '2.5rem' }}>
