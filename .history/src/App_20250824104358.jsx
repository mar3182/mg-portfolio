...
function App() {
  ...
  return (
    <div className="relative">
      ...
      <button 
        className="menu-button pulse-on-hover"
      ...
      {/* Projects Section */}
      <div className={`min-h-screen flex items-center justify-center ${sections[3].color} relative`}>
        <div className="morphing-bg"></div>
        <div className="container mx-auto px-6">
          <div className="max-w-7xl">
            <AnimatedSection>
              ...
              <p className="text-xl text-gray-700 mb-16 max-w-3xl">
                ...
                visitors in a powerful and impactful digital experience. I believe 
                that nothing beats an immersive experience, and especially one that 
                is uniquely yours.
              </p>
            </AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-container">
              {projects.map((project, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="project-card bg-white rounded-lg border-4 border-black overflow-hidden"
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-gray-600 mb-3 font-medium">{project.category}</p>
                    <p className="text-gray-700 mb-4">{project.description}</p>
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                      <p className="text-sm text-green-800 font-medium">{project.metrics}</p>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map((tag) => (
                        <span key={tag} className="px-2 py-1 bg-gray-100 rounded text-xs font-medium skill-tag">
                          {tag}
                        </span>
                      ))}
                    </div>
