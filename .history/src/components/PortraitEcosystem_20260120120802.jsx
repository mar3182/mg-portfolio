...
function PortraitEcosystem() {
  ...
  const animate = useCallback((time) => {
    ...
    // SWAPPED: User reported inversion, so flora = identity, circuit = 1 - identity
    const floraOpacity = Math.max(0.15, currentIdentity)
    const circuitOpacity = Math.max(0.15, 1 - currentIdentity)
