...
import { useIdentityActions, useSmoothedIdentity, useIdentitySpringConfig } from '../hooks/useIdentity'
...
export default function SplitPortraitHero({ 
  ...
  // Note: smoothedIdentity and identitySpringConfig available for future enhancements
  // const smoothedIdentity = useSmoothedIdentity()
  // const identitySpringConfig = useIdentitySpringConfig()
