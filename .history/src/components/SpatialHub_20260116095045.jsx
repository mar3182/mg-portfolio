  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="edge-glow" style={{ background: `linear-gradient(90deg, ${SECTIONS.design.color}10, transparent)` }} />
      </div>
      ...
      >
        ...
        <div className="edge-glow" style={{ background: `linear-gradient(-90deg, ${SECTIONS.tech.color}10, transparent)` }} />
      </div>
