...
function PortraitEcosystem() {
  ...
  const animate = useCallback((time) => {
    ...
    // BOTH visible at minimum 0.3 opacity so user can always see growth
    const floraOpacity = Math.max(0.3, 1 - currentIdentity)
    const circuitOpacity = Math.max(0.3, currentIdentity)
