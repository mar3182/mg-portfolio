      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            {/* Vertical stem - short line connecting to portrait edge */}
            <Motion.div 
              ...
              transition={{ 
                scaleY: { duration: 0.3, delay: 0.4, ease: [0.22, 1, 0.36, 1] },
                y: { duration: 0.8, delay: 0.2, ease: [0.22, 1, 0.36, 1] },
              }}
            />
          </Motion.div>
          ...
          {/* === PORTRAIT EDGE LINE === */}
          {/* The vertical line at center representing the portrait seen edge-on */}
          <Motion.div 
            className="splash-portrait-edge"
            initial={{ opacity: 0, scaleY: 0 }}
            animate={{ 
              opacity: isTComplete ? 1 : 0,
              scaleY: isTComplete ? 1 : 0,
            }}
            exit={{ opacity: 0 }}
            transition={{ 
              opacity: { duration: 0.4, delay: 0.5 },
              scaleY: { duration: 0.6, delay: 0.5, ease: [0.22, 1, 0.36, 1] },
              exit: { duration: 0.5 }
            }}
          />
