...
import ExpandedSideView from './ExpandedSideView'
...
export default function SplitPortraitHero({ 
  ...
  const [expandedSide, setExpandedSide] = useState(null) // 'design' | 'tech' | null
  ...
  const handleClick = useCallback((e) => {
    ...
    if (currentX < 0.45) {
      console.log('Expanding DESIGN side')
      setExpandedSide('design')
      onNavigate?.('design')
    } else if (currentX > 0.55) {
      console.log('Expanding TECH side')
      setExpandedSide('tech')
      onNavigate?.('tech')
    }
  }, [mouseX, onNavigate])
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* T-shaped Professional tagline */}
          <Motion.span
            className="t-tagline"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: isAnimatedIn ? 1 : 0, y: isAnimatedIn ? 0 : 10 }}
      ...
      {/* Expanded Side View - shows full Design or Tech section */}
      <ExpandedSideView
        side={expandedSide}
        isExpanded={expandedSide !== null}
        avatarImage={expandedSide === 'design' ? designImage : techImage}
