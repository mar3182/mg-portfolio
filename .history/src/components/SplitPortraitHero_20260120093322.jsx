...
export default function SplitPortraitHero({ 
  ...
  // At center (0.5): split portrait visible
  // At left (0): design portrait visible (looking left)
  // At right (1): tech portrait visible (looking right)
  
  // Opacity crossfades between three portraits
