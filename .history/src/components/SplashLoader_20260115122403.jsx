      ...
      {isVisible && (
        ...
        >
          ...
          <Motion.p
            ...
            animate={{ 
              opacity: phase === 'split' || phase === 't-form' ? 1 : 0, 
              y: phase === 'split' || phase === 't-form' ? 0 : 10 
            }}
          ...
          {/* T-SHAPE: Forms as M|G split apart */}
          <div className="splash-t-shape">
            {/* Horizontal line - draws from center outward */}
            <Motion.div 
              className="splash-t-horizontal"
              initial={{ scaleX: 0, opacity: 0 }}
              animate={{ 
                scaleX: phase === 't-form' || phase === 'exit' ? 1 : 0,
                opacity: phase === 'exit' ? 0 : (phase === 't-form' ? 1 : 0),
              }}
              transition={{ 
            ...
            {/* Vertical line - drops down from horizontal */}
            <Motion.div 
              className="splash-t-vertical"
              initial={{ scaleY: 0, opacity: 0 }}
              animate={{ 
                scaleY: phase === 't-form' || phase === 'exit' ? 1 : 0,
                opacity: phase === 'exit' ? 0 : (phase === 't-form' ? 1 : 0),
              }}
              transition={{ 
