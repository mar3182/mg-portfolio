...
// Tech side - pure black tones
const TECH_BG = '#000000'          // Pure black
const TECH_BG_LIGHT = '#0a0a0a'    // Slightly lighter for depth
const TECH_ACCENT = '#1a1a2e'      // Deep blue-black accent

// Neutral center
const NEUTRAL_BG = '#2a2520'       // Warm dark neutral
