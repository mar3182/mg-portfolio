 ...
 * Renders the living background and decorative layers.
 * 
 * Props:
...
export { 
  ...
  useIdentityColorTransform,
  useIdentityLabel,
  useIsDesign,
  useIsTech,
  useIdentityIntensity,
  useIdentitySpringConfig,
  useIdentityTransitionConfig,
  useHeroIdentityControl,
} from '../hooks/useIdentity'

// Export identity text components
export { 
  IdentityHeading, 
  IdentityParagraph, 
  IdentityLabel, 
