...
function PortraitEcosystem() {
  ...
  const animate = useCallback((time) => {
    ...
    // Flora fades out on tech side, circuit fades out on design side
    // At identity 0 (design): flora = 0.5, circuit = 0.02
    // At identity 0.5 (center): flora = 0.25, circuit = 0.25
    // At identity 1 (tech): flora = 0.02, circuit = 0.5
    const floraBaseOpacity = Math.max(0.02, (1 - currentIdentity) * 0.5)
    const circuitBaseOpacity = Math.max(0.02, currentIdentity * 0.5)
