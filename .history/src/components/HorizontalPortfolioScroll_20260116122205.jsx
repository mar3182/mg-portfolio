...
export default function HorizontalPortfolioScroll({
  ...
  // Mouse tracking for peek effect
  ...
  // Avatar position transforms based on scroll
  const avatarX = useTransform(scrollXProgress, [0, 0.5, 1], ['0%', '0%', '0%'])
  ...
  // Effect intensity based on scroll position
  const floralIntensity = useTransform(scrollXProgress, [0, 0.3, 0.5], [1, 0.5, 0])
  const matrixIntensity = useTransform(scrollXProgress, [0.5, 0.7, 1], [0, 0.5, 1])
