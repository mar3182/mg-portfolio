...
// Design identity - muted warmth
const DESIGN_WARM = '#1a1512'      // Muted warm dark
const DESIGN_ACCENT = '#2a1f18'    // Subtle terracotta undertone

// Tech identity - muted coolness  
const TECH_COOL = '#0c0e12'        // Muted cool dark
const TECH_ACCENT = '#0a1218'      // Subtle navy undertone
...
function IdentityBackground() {
  ...
  // ─── LAYER 3: Accent/Energy (Barely Noticeable) ───
  // If you notice it consciously, it's too strong
