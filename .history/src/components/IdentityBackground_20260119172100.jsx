...
function IdentityBackground() {
  ...
  // Accent glow color - INCREASED INTENSITY for visibility
  const glowColorDesign = 'rgba(196, 112, 58, 0.25)'
  const glowColorTech = 'rgba(58, 156, 196, 0.25)'
  const glowColor = useTransform(
    smoothIdentity, 
    [0, 0.5, 1], 
    [glowColorDesign, 'rgba(128, 128, 128, 0.08)', glowColorTech]
  )
  
  // Secondary glow (opposite corner) - INCREASED
  const secondaryGlowOpacity = useTransform(smoothIdentity, [0, 0.5, 1], [0.15, 0.08, 0.15])
