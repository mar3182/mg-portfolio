...
export default function SplitPortraitHero({ 
  ...
  // === IDENTITY TITLE OPACITY ===
  // Design title: fades in as user moves left
  const designTitleOpacity = useTransform(smoothX, [0.5, 0.2, 0], [0, 0.5, 0.8])
  // Tech title: fades in as user moves right
  const techTitleOpacity = useTransform(smoothX, [0.5, 0.8, 1], [0, 0.5, 0.8])
  ...
  return (
    ...
    >
      ...
      <Motion.div 
        ...
        style={{ x: scenePanX }}
      >
        {/* === IDENTITY TITLES — Award-Level Typography === */}
        <Motion.div 
        ...
        <Motion.div 
          ...
          style={{ opacity: techTitleOpacity }}
        >
