      ...
      >
        ...
        >
          ...
          <div className="nav-track">
            ...
            {/* The track line with vertical stem inside */}
            <div className="nav-track__line">
              ...
              {/* Vertical Line - stem of T, positioned relative to horizontal line */}
              <Motion.div 
                className="t-vertical-stem"
                initial={{ scaleY: 1, opacity: 1 }}
                animate={{ opacity: verticalLineOpacity }}
          ...
          <Motion.span
            ...
            animate={{ opacity: verticalLineOpacity, y: 0 }}
            transition={{ duration: 0.4 }}
          >
        ...
        {/* === PORTRAIT EDGE LINE === */}
        {/* This is the "edge" of the portrait card seen from the side */}
        {/* Fades out as portrait rotates into view */}
        <Motion.div 
          className="portrait-edge-line"
          initial={{ opacity: 1 }}
          animate={{ opacity: verticalLineOpacity }}
