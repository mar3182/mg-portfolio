...
export default function HomeFocusPanels({ onFocusChange, externalActiveKey }) {
  ...
  const ServicePreview = ({ area, isHovered, isExpanded }) => {
  ...
  return (
    ...
    >
      ...
      {/* Floating Service Panels Container */}
      <Motion.div 
        ...
        <div className="scroll-indicators">
          ...
          <div className="scroll-dots">
            ...
            <Motion.button
              ...
              className={`focus-panel focus-panel--${viewMode}${isActive ? ' is-active' : ''}${isHovered ? ' is-hovered' : ''}`}
              style={{ '--panel-color': area.color }}
              layout
              initial={{ opacity: 0, y: 24 }}
              animate={{ 
