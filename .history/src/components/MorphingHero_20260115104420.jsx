 ...
 * 
 * Alternates between two professional identities:
 * - "Full Stack Developer" (Tech side — Sans-serif, geometric, cool)
 * - "Creative Designer" (Design side — Serif, organic, warm)
 * 
 * The typography, colors, and particle system morph to reflect each world.
 */
...
const CYCLE_DURATION = 5000 // 5 seconds per identity
const TRANSITION_DURATION = 1.2 // seconds for the morph
