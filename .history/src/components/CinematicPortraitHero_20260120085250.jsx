...
function CinematicPortraitHero({
  ...
  const handleMouseMove = useCallback((e) => {
    ...
    // Track current zone for visual feedback
    const zone = clampedX < 0.35 ? 'design' : clampedX > 0.65 ? 'tech' : 'neutral'
    
    // Notify parent of identity change (for visual feedback only, NOT navigation)
    if (onIdentityChange) {
  ...
  return (
    ...
    >
      ...
      {/* Identity Labels - Clickable for Step 3 navigation */}
      <IdentityLabel side="design" opacity={designLabelOpacity} onClick={onNavigate} />
      <IdentityLabel side="tech" opacity={techLabelOpacity} onClick={onNavigate} />
