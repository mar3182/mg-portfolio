...
export default function SplitPortraitHero({ 
  ...
  // Uses smoothX directly - single spring, no layering
  // Design: Full at 0, fades out by 0.35
  const designOpacity = useTransform(smoothX, [0, 0.25, 0.4], [1, 0.8, 0])
  
  // Split: Appears 0.3-0.7 range (center)
  const splitOpacity = useTransform(smoothX, [0.25, 0.4, 0.6, 0.75], [0, 1, 1, 0])
  
  // Tech: Full at 1, fades out by 0.65
  const techOpacity = useTransform(smoothX, [0.6, 0.75, 1], [0, 0.8, 1])
