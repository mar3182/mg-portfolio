...
export default function AppLayout() {
  ...
  const [LogoIntroComp, setLogoIntroComp] = useState(null)
  ...
  // Dynamically load animated intro ASAP but after first paint
  useEffect(() => {
    requestAnimationFrame(() => {
      import('./components/LogoIntro').then(m => setLogoIntroComp(() => m.default)).catch(()=>{})
    })
  }, [])
  ...
  {LogoIntroComp && <LogoIntroComp show={!introDone} onFinish={() => setIntroDone(true)} />}
