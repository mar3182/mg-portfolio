...
// Social links
const SOCIAL_LINKS = [
  { abbr: 'Be', label: 'Behance', url: '#' },
  { abbr: 'Dr', label: 'Dribbble', url: '#' },
  { abbr: 'In', label: 'LinkedIn', url: '#' },
]
...
/**
 * Navigation Sidebar — Fixed left nav from living-portrait
 */
const NavigationSidebar = memo(function NavigationSidebar({ isLoaded }) {
  return (
    <nav className="t-hero__nav-sidebar">
...
/**
 * Social Links Bar — Fixed right side from living-portrait
 */
const SocialLinksBar = memo(function SocialLinksBar() {
  const icons = [
  ...
  return (
    <div className="t-hero__social-links">
      {icons.map((link, i) => (
        <motion.a
          key={link.label}
          href="#"
