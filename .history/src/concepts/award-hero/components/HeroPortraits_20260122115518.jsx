 ...
 * Center focus with subtle idle animations
 */
...
export function HeroPortraits({ parallaxX, parallaxY, onHover, onLeave }) {
  ...
  useEffect(() => {
    // Start idle animations after initial load
  ...
  return (
    <div className="hero-portraits-container">
      ...
      <motion.div 
        ...
        style={{
          x: useTransform(parallaxX, (x) => x * -1.8),
          y: useTransform(parallaxY, (y) => y * 1.0),
        }}
      ...
      >
        <motion.div 
          className="portrait-image-wrapper matrix-overlay"
          animate={isIdle ? { 
            y: [0, -5, 0],
          } : {}}
          transition={{ 
      ...
      {/* Center Portrait - Main B&W with color accents - PRIMARY FOCUS */}
      <motion.div 
        className="portrait portrait-center"
        style={{
          y: useTransform(parallaxY, (y) => y * 0.4 + 15),
        }}
      ...
      >
        <motion.div 
          className="portrait-image-wrapper center-portrait"
          animate={isIdle ? { 
            scale: [1, 1.008, 1],
          } : {}}
          transition={{ 
        ...
        >
          {/* Center glow effect */}
          <div className="center-portrait-glow" />
      ...
      {/* Right Portrait - Warm/Creative Version - REDUCED DOMINANCE */}
      <motion.div 
      ...
      >
        <motion.div 
          className="portrait-image-wrapper warm-overlay"
          animate={isIdle ? { 
            y: [0, 6, 0],
          } : {}}
          transition={{ 
