    ...
    <div className="hero-portraits-container">
      ...
      >
        <div className="portrait-image-wrapper matrix-overlay">
          ...
          {/* Portrait silhouette */}
          <div 
            className="portrait-silhouette tech-green"
            style={{
              backgroundImage: 'url(/concepts/award-hero/portrait-left.png)',
            }}
          />
      ...
      >
        <div className="portrait-image-wrapper center-portrait">
          <div 
            ...
            style={{
              backgroundImage: 'url(/concepts/award-hero/portrait-center.png)',
            }}
          />
      ...
      >
        <div className="portrait-image-wrapper warm-overlay">
          <div 
            className="portrait-silhouette warm-gradient"
            style={{
              backgroundImage: 'url(/concepts/award-hero/portrait-right.png)',
            }}
          />
