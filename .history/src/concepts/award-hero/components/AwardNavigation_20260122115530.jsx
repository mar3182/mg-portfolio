...
function MagneticNavItem({ item, index, onHover, onLeave }) {
      ...
      >
        ...
        {item.active && (
          <motion.span 
            ...
            layoutId="activeNav"
            animate={{ 
              boxShadow: ['0 0 8px rgba(0, 255, 136, 0.5)', '0 0 16px rgba(0, 255, 136, 0.8)', '0 0 8px rgba(0, 255, 136, 0.5)']
            }}
