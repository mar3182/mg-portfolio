  ...
  return (
    ...
    >
      ...
      <main className="award-hero-main">
        ...
        {/* Focus vignette - guides eye to center */}
              ...
              <div className="hero-copy-group">
                ...
                >
                  ...
                  <motion.span 
                    ...
                    initial={{ letterSpacing: '0.4em', opacity: 0, x: 80 }}
                    animate={{ letterSpacing: '0.02em', opacity: 1, x: 0 }}
                ...
                {/* Personal Manifesto - tightly grouped */}
                <motion.p 
