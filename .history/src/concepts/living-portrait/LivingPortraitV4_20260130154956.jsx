...
const GradientBackground = memo(function GradientBackground({ identity }) {
  const warmOpacity = useTransform(identity, [0, 0.5, 1], [0.4, 0.1, 0])
  const coolOpacity = useTransform(identity, [0, 0.5, 1], [0, 0.1, 0.4])
...
const GradientShapes = memo(function GradientShapes({ identity }) {
  const designShapesOpacity = useTransform(identity, [0, 0.5, 0.8], [0.5, 0.2, 0])
  const techShapesOpacity = useTransform(identity, [0.2, 0.5, 1], [0, 0.2, 0.5])
