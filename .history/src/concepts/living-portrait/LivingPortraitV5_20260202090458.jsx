...
const VideoBackgrounds = memo(function VideoBackgrounds({ identity }) {
  ...
  return (
    <div className="lpv5-videos">
      <motion.div className="lpv5-video lpv5-video--design" style={{ opacity: designVideoOpacity }}>
      ...
      <motion.div className="lpv5-video lpv5-video--tech" style={{ opacity: techVideoOpacity }}>
        <video autoPlay muted loop playsInline>
...
// ═══════════════════════════════════════════════════════════════════════════
// WORLD DECORATIONS — Organic (design) vs Geometric (tech)
// ═══════════════════════════════════════════════════════════════════════════
...
const WorldDecorations = memo(function WorldDecorations({ identity }) {
  ...
  return (
    <div className="lpv5-decorations">
      ...
      <motion.div className="lpv5-deco lpv5-deco--design" style={{ opacity: designOpacity }}>
      ...
      <motion.div className="lpv5-deco lpv5-deco--tech" style={{ opacity: techOpacity }}>
...
// ═══════════════════════════════════════════════════════════════════════════
// AREA MARKERS — Horizontal navigation points
// ═══════════════════════════════════════════════════════════════════════════
