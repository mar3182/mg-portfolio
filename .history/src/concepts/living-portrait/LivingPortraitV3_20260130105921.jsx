...
export default function LivingPortraitV3() {
  ...
  return (
    ...
    >
      ...
      {/* ═══ LAYER 3: HORIZONTAL POSITION INDICATOR ═══ */}
      <HorizontalIndicator identity={identity} />
...
const HorizontalIndicator = memo(function HorizontalIndicator({ identity }) {
  ...
  return (
    <div className="lpv3-h-indicator">
      <div className="lpv3-h-indicator__track">
        {/* Zone markers */}
        <div className="lpv3-h-indicator__zone lpv3-h-indicator__zone--design" />
        <div className="lpv3-h-indicator__zone lpv3-h-indicator__zone--self" />
        <div className="lpv3-h-indicator__zone lpv3-h-indicator__zone--tech" />
        
        {/* Current position */}
        <motion.div 
          className="lpv3-h-indicator__thumb"
          style={{ 
            left: indicatorX,
