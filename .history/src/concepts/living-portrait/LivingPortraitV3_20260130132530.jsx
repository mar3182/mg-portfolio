  ...
  return (
    ...
    >
      ...
      <main className="lpv3-main">
        ...
        >
          <h1 className="lpv3-identity__name">
            <span className="lpv3-identity__role lpv3-identity__role--design">Designer</span>
            <span className="lpv3-identity__x">×</span>
            <span className="lpv3-identity__role lpv3-identity__role--tech">Developer</span>
          </h1>
