...
const CONFIG = {
  ...
  scrollSpeed: 0.0008,
  // Total width of the horizontal world (in viewport widths)
  worldWidth: 4, // 4x viewport = 400vw total
...
export default function LivingPortraitV5() {
  ...
  // progress 0 = show Design side (translate right to show left content)
  // progress 0.5 = center (portrait)
  // progress 1 = show Tech side (translate left to show right content)
...
const VideoBackgrounds = memo(function VideoBackgrounds({ identity }) {
  const designVideoOpacity = useTransform(identity, [0, 0.2, 0.4, 0.5], [0.5, 0.3, 0.1, 0])
  const techVideoOpacity = useTransform(identity, [0.5, 0.6, 0.8, 1], [0, 0.1, 0.3, 0.5])
  
  return (
    <>
      {/* Design video - positioned on the left side of the world */}
      <motion.div 
      ...
      {/* Tech video - positioned on the right side of the world */}
      <motion.div 
