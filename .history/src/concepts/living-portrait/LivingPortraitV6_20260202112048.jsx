 ...
 * 
 * Like Akaru.fr:
 * - Horizontal scroll moves between AREAS (expertise categories)
 * - Vertical scroll within each area reveals PROJECTS stacked below
 * - Smooth, fluid transitions with spring physics
 */
  ...
  const handleWheel = useCallback((e) => {
    ...
    if (projectCount === 0 || currentY <= 0) {
      ...
      if (delta > 0) {
        ...
        const newY = Math.max(0, currentY + delta * 0.8)
        scrollY.set(newY)
      }
    }
  }, [scrollX, scrollY])
