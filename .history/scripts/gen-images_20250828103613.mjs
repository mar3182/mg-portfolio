...
const MANIFEST_JSON_PATH = path.resolve(__dirname, '../src/data/projectImageManifest.json')
const MANIFEST_JS_PATH = path.resolve(__dirname, '../src/data/projectImageManifest.mjs')
...
;(async()=>{
  ...
  fs.writeFileSync(MANIFEST_JS_PATH, `// Auto-generated by gen-images.mjs\nexport default ${JSON.stringify(manifest, null, 2)};\n`)
  console.log('Manifest written JSON:', MANIFEST_JSON_PATH)
  console.log('Manifest written JS:', MANIFEST_JS_PATH)
  console.log('Done.')
})()
