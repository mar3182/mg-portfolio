...
- `sprint/<NN>-<goal-slug>` – Timeboxed sprint branch (e.g. `sprint/01-expertise-awards`).
...
- Interaction & Motion
- Content Sections (Expertise, Awards, Agency, Projects)
- Performance & Tooling
- Accessibility & SEO
...
| #2  | Awards counters + layout       | feature | 5   |
...
"Improve breadth of content by adding Expertise & Awards foundations while maintaining performance (no >5% bundle growth)."
