const n=[{id:1,slug:"building-modern-web-applications-with-react",title:"Building Modern Web Applications with React",excerpt:"Exploring the latest patterns and best practices for creating performant, scalable React applications in 2025.",content:`# Building Modern Web Applications with React
...
The key is to stay updated with the ecosystem while being selective about which new technologies to adopt. Focus on solving real problems rather than chasing the latest trends.`,author:"Mary Garcia",publishedAt:"2025-01-15",updatedAt:"2025-01-15",categories:["React","Web Development","Performance"],tags:["javascript","react","vite","performance","frontend"],readingTime:"8 min read",featured:!0,seo:{metaDescription:"Learn modern React development patterns and best practices for building performant web applications in 2025.",keywords:["React","JavaScript","Web Development","Performance","Frontend","Modern Web Apps"]}},{id:2,slug:"ai-integration-in-modern-development",title:"AI Integration in Modern Development Workflows",excerpt:"How artificial intelligence and machine learning are transforming the way we build and optimize web applications.",content:`# AI Integration in Modern Development Workflows
...
The key is thoughtful integration—using AI where it adds value while preserving the craft and intentionality that makes great software.`,author:"Mary Garcia",publishedAt:"2024-12-20",updatedAt:"2024-12-20",categories:["AI","Development","Productivity"],tags:["ai","machine-learning","automation","development-tools","workflow"],readingTime:"7 min read",featured:!0,seo:{metaDescription:"Discover how AI and machine learning are transforming modern development workflows and enhancing productivity.",keywords:["AI","Machine Learning","Development Tools","Automation","Productivity","Web Development"]}},{id:3,slug:"php-microservices-architecture-guide",title:"PHP Microservices Architecture: A Comprehensive Guide",excerpt:"Building scalable microservices with PHP, exploring patterns, tools, and best practices for enterprise-grade applications.",content:`# PHP Microservices Architecture: A Comprehensive Guide
...
RUN apk add --no-cache     nginx     postgresql-dev     zip     unzip
...
Success comes from starting small, iterating quickly, and building robust monitoring and deployment pipelines from day one.`,author:"Mary Garcia",publishedAt:"2024-11-30",updatedAt:"2024-11-30",categories:["PHP","Architecture","Backend"],tags:["php","microservices","architecture","symfony","backend","scalability"],readingTime:"12 min read",featured:!1,seo:{metaDescription:"Complete guide to building scalable PHP microservices architecture with modern patterns and best practices.",keywords:["PHP","Microservices","Architecture","Symfony","Backend Development","Scalability"]}}],a=["All","React","PHP","AI","Web Development","Architecture","Performance","Backend","Development","Productivity"],s=t=>t==="All"?n:n.filter(e=>e.categories.includes(t)),o=t=>n.find(e=>e.slug===t),c=(t=5)=>[...n].sort((e,r)=>new Date(r.publishedAt)-new Date(e.publishedAt)).slice(0,t),l=t=>{const e=t.toLowerCase();return n.filter(r=>r.title.toLowerCase().includes(e)||r.excerpt.toLowerCase().includes(e)||r.content.toLowerCase().includes(e)||r.tags.some(i=>i.toLowerCase().includes(e)))};export{n as a,a as b,o as c,c as d,s as g,l as s};
