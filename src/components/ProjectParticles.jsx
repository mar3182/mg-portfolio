...
export default function ProjectParticles({ mouseX, mouseY, isReady = true }) {
  ...
  // Mobile tap handler - shows preview modal with project name
  const handleTap = useCallback((id, title, category, image, color, x, y) => {
    setMobilePreview({ id, title, category, image, color, x, y })
  }, [])
