...
export const technicalSkills = {
  ...
  technologies: [
    ...
    { name: 'Smart Contracts', level: 'Advanced', years: 3, description: 'Solidity, Web3.js, Ethereum, multi-chain deployment' },
    { name: 'Web3 Integration', level: 'Advanced', years: 3, description: 'Wallet connections, DeFi protocols, blockchain interactions' },
  ...
  specializations: [
    ...
    { name: 'Blockchain Development', level: 'Advanced', years: 3, description: 'Smart contracts, DeFi protocols, NFT marketplaces, Web3 integration' },
